...
public class sendEnvelopeDisposableCert2s extends sendEnvelopeBase{
	...
	public static String r2DocumentIssuedOn; 
	public static String r2DocumentExpiryDate; 	
	public static String r2SerialNumber;
	public static String r2DocumentNumber;
	...
	public static void setR1PhoneMobile(String r1PhoneMobile) {
		sendEnvelopeDisposableCert2s.r1PhoneMobile = r1PhoneMobile;
	}
	...
	public static void setR1DocumentIssuedOn(String r1DocumentIssuedOn) {
		sendEnvelopeDisposableCert2s.r1DocumentIssuedOn = r1DocumentIssuedOn;
	}
	...
	public static void setR1DocumentExpiryDate(String r1DocumentExpiryDate) {
		sendEnvelopeDisposableCert2s.r1DocumentExpiryDate = r1DocumentExpiryDate;
	}
	public static String getR1SerialNumber() {
		return r1SerialNumber;
	}
	public static void setR1SerialNumber(String r1SerialNumber) {
		sendEnvelopeDisposableCert2s.r1SerialNumber = r1SerialNumber;
	}
	...
	public static void setR1DocumentNumber(String r1DocumentNumber) {
		sendEnvelopeDisposableCert2s.r1DocumentNumber = r1DocumentNumber;
	}

	public static String getR2PhoneMobile() {
		return r2PhoneMobile;
	}
	public static void setR2PhoneMobile(String r2PhoneMobile) {
		sendEnvelopeDisposableCert2s.r2PhoneMobile = r2PhoneMobile;
	}
	public static String getR2DocumentIssuedOn() {
		return r2DocumentIssuedOn;
	}
	public static void setR2DocumentIssuedOn(String r2DocumentIssuedOn) {
		sendEnvelopeDisposableCert2s.r2DocumentIssuedOn = r2DocumentIssuedOn;
	}
	public static String getR2DocumentExpiryDate() {
		return r2DocumentExpiryDate;
	}
	public static void setR2DocumentExpiryDate(String r2DocumentExpiryDate) {
		sendEnvelopeDisposableCert2s.r2DocumentExpiryDate = r2DocumentExpiryDate;
	}
	public static String getR2SerialNumber() {
		return r2SerialNumber;
	}
	public static void setR2SerialNumber(String r2SerialNumber) {
		sendEnvelopeDisposableCert2s.r2SerialNumber = r2SerialNumber;
	}
	public static String getR2DocumentNumber() {
		return r2DocumentNumber;
	}
	public static void setR2DocumentNumber(String r2DocumentNumber) {
		sendEnvelopeDisposableCert2s.r2DocumentNumber = r2DocumentNumber;
	}
	...
	public static void setParameters(String envelopeName, String r1Email,String r1FirstName, String r1LastName,
			...
			String r2PhoneMobile, String r2DocumentIssuedOn, String r2DocumentExpiryDate, String r2SerialNumber,
			String  r2DocumentNumber) {
		...
		setR2PhoneMobile(r2PhoneMobile);
		setR2DocumentIssuedOn(r2DocumentIssuedOn);
		setR2DocumentExpiryDate(r2DocumentExpiryDate);
		setR2SerialNumber(r2SerialNumber);
		setR2DocumentNumber(r2DocumentNumber);
	...
	public static String getRequest() {
		return "{\r\n"
				...
				+ "            \"IdentificationCountry\": \"HU\",\r\n"
				+ "            \"IdentificationType\": \"PASSPORT\",\r\n"
				+ "            \"PhoneMobile\": \""+r2PhoneMobile+"\",\r\n"
				+ "            \"DocumentType\": \"PASS\",\r\n"
				+ "            \"DocumentIssuedBy\": \"Namirial\",\r\n"
				+ "            \"DocumentIssuedOn\": \""+r2DocumentIssuedOn+"\",\r\n"
				+ "            \"DocumentExpiryDate\": \""+r2DocumentExpiryDate+"\",\r\n"
				+ "            \"SerialNumber\": \""+r2SerialNumber+"\",\r\n"
				+ "            \"DocumentNumber\": \""+r2DocumentNumber+"\",\r\n"
				+ "            \"OverrideHolderInCaseOfMismatch\": false\r\n"
				+ "          }\r\n"
				+ "        }\r\n"
				+ "      ],\r\n"
				...
				+ "            \"EMail\": \""+r1Email+"\"\r\n"
				+ "          },\r\n"
				+ "          \"HolderInformation\": \"<recognitionType>PASS</recognitionType><documentIssuedOn>07/07/2020</documentIssuedOn><documentExpiryDate>29/07/2021</documentExpiryDate><documentIssuedBy>Namirial</documentIssuedBy><documentNumber>1234</documentNumber><countryResidence>HU</countryResidence><firstName>Barnabas</firstName><lastName>Lukacs</lastName><email>barnaslukacs@gmail.com</email><phoneMobile>+36206196321</phoneMobile><identificationType>PASSPORT</identificationType><identificationCountry>HU</identificationCountry><passport>12345</passport>\",\r\n"
				+ "          \"TransactionCodePushPluginData\": []\r\n"
				+ "        },\r\n"
				+ "        \"SenderInformation\": {\r\n"
				+ "          \"UserInformation\": {\r\n"
				...
				+ "                    \"TrConfId\": \"remoteCertificateSignSmsText\",\r\n"
				+ "                    \"IsPhoneNumberRequired\": false,\r\n"
				+ "                    \"Id\": \"180c4201-4146-4161-baf8-cb5a607eec63\",\r\n"
				+ "                    \"DiscriminatorType\": \"SigTypeTransactionCode\",\r\n"
				+ "                    \"Preferred\": false,\r\n"
				+ "                    \"StampImprintConfiguration\": {\r\n"
				+ "                      \"DisplayExtraInformation\": true,\r\n"
				...
				+ "                \"UseTimestamp\": false,\r\n"
				+ "                \"IsRequired\": true,\r\n"
				+ "                \"Id\": \"1#XyzmoDuplicateIdSeperator#Signature_b58c192b-47c0-5339-cb18-4fe77c3d1813\",\r\n"
				+ "                \"DisplayName\": \"\",\r\n"
				+ "                \"DocRefNumber\": 1,\r\n"
				+ "                \"DiscriminatorType\": \"Signature\"\r\n"
				+ "              }\r\n"
